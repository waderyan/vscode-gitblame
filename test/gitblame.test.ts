...
suite("Web URL formatting", () => {
  ...
  test("username@", () => {
    assert.equal(
      blame.defaultWebPath("username@example.com:user/repo.git", "hash", false),
      "https://example.com/user/repo/commit/hash",
    );
    assert.equal(
      blame.defaultWebPath("username@example.com:user/repo", "hash", false),
      "https://example.com/user/repo/commit/hash",
    );
  });
  ...
  test("https:// plural", () => {
    assert.equal(
      blame.defaultWebPath("https://example.com/user/repo.git", "hash", true),
